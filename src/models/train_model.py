...
# --------------------------------------------------------------
# Select best models and evaluate results
# --------------------------------------------------------------

# Random forest 0.9564879564879565
(
    class_train_y,
    class_test_y,
    class_train_prob_y,
    ...
    X_train[selected_features_2], y_train, X_test[selected_features_2], gridsearch=True
)
...
# k Nearest Neighbor 0.95998445998446
(
    class_train_y,
    class_test_y,
    class_train_prob_y,
